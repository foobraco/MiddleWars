...
public class Rectangle {
	public float Left, Top, Width, Height, Factor;
	...
	public static Vector2 GetIntersectionDepth(Rectangle rectA, Rectangle rectB) {
		...
		// Calculate centers.
		Vector2 centerA = new Vector2(rectA.Left + halfWidthA, rectA.Top
				+ halfHeightA);
		Vector2 centerB = new Vector2(rectB.Left + halfWidthB, rectB.Top
				+ halfHeightB);
