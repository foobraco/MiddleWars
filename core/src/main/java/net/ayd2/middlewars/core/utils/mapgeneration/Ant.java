...
//
//This class will act as an observer of the activity of the Ant instances wich are forming the map, registering and unregistering them when needed
//Esta clase estara actuando como observador de la actividad de las instancias de Ant que forman el mapa, registrandolas y desregistrandolas cuando sea necesario
